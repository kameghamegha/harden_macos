...
module OSHardeningCookbookMacOS
  module HardeningHelpers
    ...
    def harden_macos_firewall
      ...
      # Enable the OS X System Firewall
    ...
    def harden_macos_devices
      ...
      # TODO: Verify the value returned for the UIDFilter does not equal none
      # ^ Actually...it does. Why is that a problem? 
    ...
    def harden_macos_network
      ...
      # TODO - this command gives an error on macOS 10.11.  Check out.
    ...
    def harden_macos_ssh_configs
      ...
      #
      # The following variables must be set based on OS X version because the
      #   location of the ssh_config file changed between 10.10 and 10.11
      current_ssh_config = nil
      current_ssh_config = '/etc/ssh/ssh_config' if \
                            os_version == 11
      current_ssh_config = '/etc/ssh_config' if \
                            os_version == 10
      ssh_config_version = nil
      ssh_config_version = '/vulns/ssh_config1011' if \
                            os_version == 11
      ssh_config_version = '/vulns/ssh_config1010' if \
                            os_version == 10

      # Will not execute if osx_version is anything other than 10.10 or 10.11
      unless current_ssh_config.nil?
        ...
        puts(__method__.to_s + ": (2) temporary directory is: " + temp_dir)
